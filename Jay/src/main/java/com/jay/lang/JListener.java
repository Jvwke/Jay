...
public interface JListener extends ParseTreeListener {
    ...
    /**
     * Enter a parse tree produced by {@link JParser#import_list}.
     * @param ctx the parse tree
     */
    void enterImport_list(JParser.Import_listContext ctx);
    /**
     * Exit a parse tree produced by {@link JParser#import_list}.
     * @param ctx the parse tree
     */
    void exitImport_list(JParser.Import_listContext ctx);
    /**
    ...
    /**
     * Enter a parse tree produced by the {@code functionCallNative}
     * labeled alternative in {@link JParser#function_call}.
     * @param ctx the parse tree
     */
    void enterFunctionCallNative(JParser.FunctionCallNativeContext ctx);
    /**
     * Exit a parse tree produced by the {@code functionCallNative}
     * labeled alternative in {@link JParser#function_call}.
     * @param ctx the parse tree
     */
    void exitFunctionCallNative(JParser.FunctionCallNativeContext ctx);
    /**

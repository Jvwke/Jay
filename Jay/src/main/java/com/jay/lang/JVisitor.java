...
public interface JVisitor<T> extends ParseTreeVisitor<T> {
    ...
    /**
     * Visit a parse tree produced by {@link JParser#import_list}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitImport_list(JParser.Import_listContext ctx);
    /**
    ...
    /**
     * Visit a parse tree produced by the {@code functionCallNative}
     * labeled alternative in {@link JParser#function_call}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitFunctionCallNative(JParser.FunctionCallNativeContext ctx);
    /**
